...
emperors %>% 
  ...
  ggplot(aes(x = name, y = regne_duree, color = dynasty))+geom_point()+coord_flip()+geom_hline(aes(yintercept = median(regne_duree)), linetype = 3)+
  labs(x = "Empereur",
...
emperors %>% 
  ...
  theme_bw() + coord_flip() + facet_wrap(~rise) +
  labs(
